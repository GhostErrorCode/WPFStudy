...
namespace WPFPrismStudy.PrismRegion.ViewModels
{
    // 继承Prism的MVVM模式 - BindableBase
    public class PrismRegionMainViewModel : BindableBase
    {
        ...
        // 构造函数，初始化 ViewModel
        public PrismRegionMainViewModel(IRegionManager regionManager)
        {
        ...
        private void Open(string str)
        {
            ...
            _regionManager.Regions["PrismRegionContentControl"].RequestNavigate(str);
