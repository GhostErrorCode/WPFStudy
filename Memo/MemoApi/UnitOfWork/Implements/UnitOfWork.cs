...
namespace MemoApi.UnitOfWork.Implements
{
    // 工作单元实现类
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private readonly MemoApplicationDbContext _context;
        ...
        public UnitOfWork(MemoApplicationDbContext context)
        {
            ...
            // 初始化字段
            this._context = context;  // 存储传入的DbContext
            this._repositories = new ConcurrentDictionary<Type, object>();  // 创建空字典
        ...
        public async Task<int> SaveChangesAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                affectedRows = await this._context.SaveChangesAsync(cancellationToken);
