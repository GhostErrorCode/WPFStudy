...
namespace PrismRegionNavigation.ViewModels
{
    ...
    public class PrismRegionNavigationMainViewModel : BindableBase
    {
        ...
        // 构造函数，初始化 ViewModel
        public PrismRegionNavigationMainViewModel(IRegionManager regionManager)
        {
        ...
        private void Open(string str)
        {
            ...
            _regionManager.Regions["PrismRegionNavigationContentControl"].RequestNavigate(str);
