...
namespace PrismRegionNavigation
{
    ...
    public partial class App : PrismApplication
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            // 注册PrismRegion中的View
            containerRegistry.RegisterForNavigation<PrismRegionNavigationUserControlA>("PrismRegionNavigationUserControlA");
            containerRegistry.RegisterForNavigation<PrismRegionNavigationUserControlB>("PrismRegionNavigationUserControlB");
            containerRegistry.RegisterForNavigation<PrismRegionNavigationUserControlC>("PrismRegionNavigationUserControlC");
        }
    }
}
